...
cv2.circle(image_rgb, (center1_x,center1_y),5,(0,255,255),-1)
cv2.circle(image_rgb, (center2_x,center2_y),5,(0,255,255),-1)
cv2.line(image_rgb,(center1_x,center1_y),(center2_x,center2_y),(255,0,0),3)
font = cv2.FONT_HERSHEY_SIMPLEX
cv2.putText(image_rgb, 'Region 1', (top_left1[0], top_left1[1] + 10), font, 0.35, (255, 255, 255), 1, cv2.LINE_AA)
cv2.putText(image_rgb, 'Region 2', (top_left2[0], top_left2[1] + 10), font, 0.35, (255, 255, 255), 1, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 1', (center1_x + 40, center1_y + 40), font, 0.35, (0, 255, 0), 1, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 2', (center2_x + 40, center2_y + 40), font, 0.35, (0, 255, 0), 1, cv2.LINE_AA)
...
cv2.putText(image_rgb, f'Height: {height}px', height_label_position, font, 0.45, (255, 255, 0), 1, cv2.LINE_AA)
